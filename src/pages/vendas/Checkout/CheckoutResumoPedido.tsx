...
import { CheckoutResumoPedidoLista } from './CheckoutResumoPedidoLista';
import { CheckoutResumoPedidoAcoes } from './CheckoutResumoPedidoAcoes';
...
export const CheckoutResumoPedido = (props: Props) => (
