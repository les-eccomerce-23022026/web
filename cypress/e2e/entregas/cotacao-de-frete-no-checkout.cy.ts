 ...
 *
 * NOTA: Esta suíte mantém o fluxo completo (catálogo → carrinho → checkout)
...
function apiHeadersBancoTestes(): Record<string, string> {
...
describe('Entregas — Cotação de Frete no Checkout', () => {
  beforeEach(() => {
