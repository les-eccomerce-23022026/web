...
| **[RF0024]** | Consulta de clientes | Obrigatório | O sistema deve possibilitar que um cliente seja consultado com base em um filtro. | ⏳ Previsto | - |
...
| **[RF0038]** | Despachar produtos para entrega | Obrigatório | Administrador selecionar vendas para EM TRÂNSITO. | ⏳ Previsto | - |
| **[RF0039]** | Produtos entregues | Obrigatório | Administrador confirmar entrega (ENTREGUE). | ⏳ Previsto | - |
...
| **[RF0053]** | Dar baixa em estoque | Obrigatório | Reduzir itens vendidos. | ⏳ Previsto | - |
