...
| **[RN0039]** | Status para transporte | Obrigatório | Selecionado para entrega: EM TRANSPORTE. | ⏳ Previsto | - |
| **[RN0040]** | Status após entrega | Obrigatório | Confirmado pelo administrador: ENTREGUE. | ⏳ Previsto | - |
...
| **[RN0013]** | Definindo valor de venda | Obrigatório | Valor baseado na margem de lucro parametrizada para o grupo de precificação definido no cadastro. | ⏳ Previsto | - |
| **[RN0014]** | Validar margem de lucro | Obrigatório | Mudanças abaixo da margem exigem autorização de um gerente de vendas. | ⏳ Previsto | - |
| **[RN0015]** | Associar motivo de inativação | Obrigatório | Inativação manual exige justificativa e categoria de inativação. | ⏳ Previsto | - |
...
| **[RN0017]** | Associar motivo de ativação | Obrigatório | Ativação exige justificativa e categoria de ativação. | ⏳ Previsto | - |
| **[RN0051]** | Validar dados de estoque | Obrigatório | Produto, quantidade, valor de custo, fornecedor e data de entrada são obrigatórios. | ⏳ Previsto | - |
...
| **[RN0061]** | Quantidade mínima | Obrigatório | Não permite entrada de itens com quantidade zero. | ⏳ Previsto | - |
| **[RN0062]** | Valor de custo | Obrigatório | Obrigatório haver um valor de custo para todo item. | ⏳ Previsto | - |
| **[RN0064]** | Data de entrada | Obrigatório | Obrigatório registrar a data de entrada dos itens. | ⏳ Previsto | - |
