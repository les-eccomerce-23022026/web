...
|  6  | Painel Admin (Pedidos/Estoque)  |     6,5      |      13      |      19,5      |   🟢   | Autenticado, exibe dashboard. Gestão de Pedidos (despachar e confirmar entrega com baixa de estoque) e Gestão de Clientes funcionais.                                                                                    |
